...
func (uc *UserController) Route() {
	...
	uc.rg.GET("/users", uc.authMiddleware.RequireToken("admin"), uc.getAllUsersHandler)
	uc.rg.GET("/users/:username", uc.authMiddleware.RequireToken("admin"), uc.getUserByUsernameHandler)
}
